...
data ExprS
  ...
  | -- | Nosso >
    GS     { leftS :: ExprS, rightS :: ExprS }
  | -- | Nosso >=
    GeqS     { leftS :: ExprS, rightS :: ExprS }
  | -- | Nosso <
    LS     { leftS :: ExprS, rightS :: ExprS }
  | -- | Nosso <=
    LeqS     { leftS :: ExprS, rightS :: ExprS }
  deriving (Show, Eq)
...
data ExprC
  ...
  | -- | Nosso >
    GC { leftC :: ExprC, rightC :: ExprC } 
  | -- | Nosso >=
    GeqC { leftC :: ExprC, rightC :: ExprC } 
  | -- | Nosso <
    LC { leftC :: ExprC, rightC :: ExprC } 
  | -- | Nosso <=
    LeqC { leftC :: ExprC, rightC :: ExprC }  
  deriving (Show, Eq)
...
data Value
  ...
  | -- | Representa tipo booleano
    BoolV {boolV :: String} -- { boolV :: String}
...
-- Binding "bool" (String "true")
-- Binding "bool" (String "false")
