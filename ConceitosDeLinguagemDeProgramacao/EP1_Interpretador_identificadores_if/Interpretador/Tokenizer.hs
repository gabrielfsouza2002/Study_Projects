...
notlettersymbols :: String
notlettersymbols = "_!?-+*/%<>#~0123456789."

notvalidsymbols :: String
notvalidsymbols = "_!?-+*/%<>#~."
...
isBool :: String -> Bool
isBool s = s `elem` ["true","false"]

isNotValidSymbol :: Char -> Bool
isNotValidSymbol = (`elem` notvalidsymbols)

isNotLetter :: Char -> Bool
isNotLetter = (`elem` notlettersymbols)
